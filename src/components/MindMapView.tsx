...
import { Brain, FileText, Hash, MousePointer2 } from 'lucide-react';
...
export const MindMapView: React.FC = () => {
    ...
    return (
        <div className="w-full h-full relative cursor-grab active:cursor-grabbing overflow-hidden rounded-3xl">
                ...
                <TransformComponent wrapperClass="!w-full !h-full" contentClass="!w-[2000px] !h-[2000px]">
                    <div className="relative w-[2000px] h-[2000px]">
                        ...
                        <motion.div
                            initial={{ scale: 0 }}
                            animate={{ scale: 1 }}
                            className="absolute left-[950px] top-[950px] w-24 h-24 bg-violet-600 rounded-[2rem] flex items-center justify-center shadow-[0_0_80px_rgba(139,92,246,0.3)] z-30 border-2 border-violet-400/50"
                        >
                        ...
                        {themeNodes.map((node, i) => (
                            <React.Fragment key={node.id}>
                                ...
                                >
                                    <div className="relative px-8 py-4 rounded-[1.5rem] bg-[#1a1a1e] border-2 border-violet-500/30 shadow-2xl min-w-[180px] text-center group cursor-default">
                                        <div className={clsx(
                                            "absolute inset-0 rounded-[1.5rem] bg-gradient-to-br opacity-10 blur-2xl -z-10",
                                ...
                                {node.categories.map((cat, j) => (
                                    ...
                                    >
                                        <div className="px-4 py-2 rounded-2xl bg-[#141417]/90 border border-zinc-800 shadow-lg min-w-[140px] group flex flex-col gap-1.5 backdrop-blur-sm">
            ...
            {/* Legend Helper */}
            <div className="absolute bottom-6 left-6 flex items-center gap-4 px-4 py-2 bg-[#1a1a1e]/80 backdrop-blur-md rounded-full border border-zinc-800 text-[10px] text-zinc-500 font-bold uppercase tracking-widest pointer-events-none z-40">
                <div className="flex items-center gap-2">
